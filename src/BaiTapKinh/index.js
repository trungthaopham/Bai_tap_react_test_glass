    ...
    render() {
        return (
            <div className="" style={{ backgroundImage: 'url(./img/background.jpg)', width: '100%', height: '100%', position: 'fixed', top: '0', left: '0', backgroundRepeat: 'none', backgroundSize: 'cover' }}>
                <div className="w-100 py-3 bg-dark text-white">
                    <h2 className="display-"> TRY GLASSES APP ONLINE</h2>
                </div>
                <div className="container">
                    <div className="row py-4">
                        <div className="col-6" >
                            <div className="col-8 w-100 position-relative p-0 item">
                                ...
                                <div className="position-absolute bg-dark text-white p-2 w-100" style={{ bottom: '0', left: '0' }}>
                        ...
                        <div className="col-6" >
                            <div className="col-8 w-100 item">
